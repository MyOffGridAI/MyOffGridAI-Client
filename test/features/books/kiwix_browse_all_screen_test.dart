...
void main() {
  ...
  Widget buildScreen({UserModel? user}) {
    return ProviderScope(
      ...
      child: const MaterialApp(home: KiwixBrowseAllScreen()),
    );
  }

  group('KiwixBrowseAllScreen', () {
    testWidgets('shows app bar title', (tester) async {
      ...
      expect(find.text('Browse Kiwix Catalog'), findsOneWidget);
    });
    ...
    testWidgets('shows empty state when no entries', (tester) async {
      ...
      expect(find.text('No catalog entries'), findsOneWidget);
    });
    ...
    testWidgets('fetches with count 50 and no category', (tester) async {
      when(() => mockService.browseKiwixCatalog(
            lang: any(named: 'lang'),
            category: any(named: 'category'),
            count: any(named: 'count'),
